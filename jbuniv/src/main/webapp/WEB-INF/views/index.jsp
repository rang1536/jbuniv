                    ...
                    <div class="panel panel-primary">
                        <div class="panel-heading">
                            <div class="row">
                                ...
                                <div class="col-xs-9 text-right">
                                    <div class="huge numberInput">156,589</div>
                                    <div>어깨동무DB</div>
                                </div>
                            </div>
                        </div>
                        <a href="#">
                            <div class="panel-footer">
                                <span class="pull-left">업로드/정제</span>
                                <span class="pull-right">100% / 0%</i></span>
                    ...
                    <div class="panel panel-green">
                        <div class="panel-heading">
                            <div class="row">
                                ...
                                <div class="col-xs-9 text-right">
                                    <div class="huge numberInput">${count2 }</div>
                                    <div>발전재단DB</div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="panel panel-yellow">
                        <div class="panel-heading">
                            <div class="row">
                                ...
                                <div class="col-xs-9 text-right">
                                    <div class="huge numberInput">${count1 }</div>
                                    <div>비교정제</div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="panel panel-red">
                        <div class="panel-heading">
                            <div class="row">
                                ...
                                <div class="col-xs-9 text-right">
                                    <div class="huge numberInput">0</div>
                                    <div>기타</div>
                                </div>
                            </div>
                        </div>
